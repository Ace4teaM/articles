...
Next gère également les routes cotè serveur et vous permet d'implémenter une API simple.
...
Le nom du dossier permet également de gérer les données les plus courantes:
...
- [favicon, icône d'application, et apple-icon](https://nextjs.org/docs/app/api-reference/file-conventions/metadata/app-icons)
- [`manifest.json`](https://nextjs.org/docs/app/api-reference/file-conventions/metadata/manifest)
- [`robots.txt`](https://nextjs.org/docs/app/api-reference/file-conventions/metadata/robots)

https://nextjs.org/docs/app/guides/backend-for-frontend

Par exemple, `app/rss.xml/route.ts` crée un gestionnaire de route pour `rss.xml`.
...
**Utiliser un backend proxi**

Vous pouvez utiliser un gestionnaire de route comme un `proxy` à un autre backend. Ajoutez la logique de validation avant de transmettre la requête.
